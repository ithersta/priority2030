...
object CollectorStrings {
    ...
    object IP {
        ...
        const val OgrnDate = "Введите дату получения ОГРНИП. Формат даты: дд.мм.гггг"
        const val Location = "Введите юридический адрес предпринимателя"

        const val cityAddress = "Введите юридический адрес предпринимателя без указания области " +
                "откуда предприниматель и без населенного пункта откуда этот предпринимаель"
    ...
    object Recommendations {
        ...
        const val OgrnDate = "Введите корректную дату получения ОГРНИП, например: 31.12.2022"
