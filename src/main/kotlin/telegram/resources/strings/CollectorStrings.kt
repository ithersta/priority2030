...
object CollectorStrings {
    ...
    object FinanciallyResponsiblePerson {
        ...
        const val WorkPhoneNumber =
            "Введите рабочий номер телефона материально-ответственного лица. Формат номера: +78290367458"
    }
    ...
    object ResponsibleForDocumentsPerson {
        const val FIO = "\"Введите Инициалы и фамилию ответственного за предоставление отчетных документов\n" +
                ...
                "(Пример: Т.М. Дударенко)\"\n"
        const val ContactPhoneNumber =
            "\"Введите номер мобильного телефона ответственного за предоставление отчетных документов. Формат номера: +79290367458"
        const val WorkPhoneNumber =
            "Введите рабочий номер телефона ответственного за предоставление отчетных документов. Формат номера: +78290367458"
