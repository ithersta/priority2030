...
object CollectorStrings {
    ...
    object PurchaseCost {
        ...
        const val CostInRubles="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите 120000"
        const val CostInRublesPrescription="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите сто двадцать тысяч"
        const val CostInCops="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите 00"
        const val CostInCopsPrescription="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите ноль"
        const val Rubles="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите рублей"
        const val Cops="Введите стоимость запупки в рублях числом.\n" +
                "Например, если стоимость равна 120000 рублей 0 копеек, введите копеек"
    }
