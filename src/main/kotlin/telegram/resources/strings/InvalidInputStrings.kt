...
object InvalidInputStrings {
    ...
    const val InvalidTermOfPayment="Вы ввели некорректные данные. Возможные способы оплаты: аванс 30%, по частям, по факту. Отправьте один из этих вариантов в виде сообщения"
    const val InvalidAnswer = "Вы ввели некорректные данные. Ответ должен представлять собой только слова \"Да\" и \"Нет\". Отправьте один из этих вариантов в виде сообщения "
}